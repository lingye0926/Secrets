...
class ReadMM():
    ...
    def ReadNEXT(self):
        ...
        filepath1 = r'C:\Users\cwang2\Documents\B2B Integration\Data\latest\NEXT_MM.dat'
        filepath2 = r'C:\Users\cwang2\Documents\B2B Integration\Data\latest\NEXT_SMI_MM.dat'
        ...
        while len(sjson) > 0:
            url2 = "https://sappweb.sial.com/hanaprp/sial/sapnext/mdg/material/odata/MasterDataGovernance.xsodata/MaterialsInbox?$skip=" + str(
                start) + "&$top=" + str(
                end) + "&$select=MATNR,NORMT,ZZMGPH,KONWA,PROFL,PROFLD,ZZMSBU,ZZMSBU_DESC_SBU,PRDHA,VTEXT,MBRSH,MBBEZ,SMI,BEZEK,KBETR&$filter=%20((((MTART%20eq%20%27FERT%27%20or%20MTART%20eq%20%27HALB%27%20or%20MTART%20eq%20%27KMAT%27%20or%20MTART%20eq%20%27ZRCH%27%20or%20MTART%20eq%20%27ZVAR%27%20or%20MTART%20eq%20%27ZVFT%27%20or%20MTART%20eq%20%27ZRCH%27%20or%20MTART%20eq%20%27ZPC%27%20or%20MTART%20eq%20%27ZMTO%27%20or%20MTART%20eq%20%27FGTR%27)%20and%20MANDT%20eq%20%27100%27))%20and%20(((tolower(KZKFG)%20ne%20tolower(%27X%27)))))"
...
if __name__ == '__main__':
    ...
    MM = pd.read_csv(r'C:\Users\cwang2\Documents\B2B Integration\Data\latest\NEXT_MM.dat' ,sep='\t', encoding='utf-16', header=0)
    MM = MM.drop_duplicates()
    MM_SMI = pd.read_csv(r'C:\Users\cwang2\Documents\B2B Integration\Data\latest\NEXT_SMI_MM.dat', sep='\t', encoding='utf-16', header=0)
    MM_SMI = MM_SMI.drop_duplicates()
    MM.to_csv(r'C:\Users\cwang2\Documents\B2B Integration\Data\latest\NEXT_MM_2.dat', sep='\t', encoding='utf-8', index=False, header=False)
    MM_SMI.to_csv(r'C:\Users\cwang2\Documents\B2B Integration\Data\latest\NEXT_SMI_MM_2.dat', sep='\t', encoding='utf-8',
